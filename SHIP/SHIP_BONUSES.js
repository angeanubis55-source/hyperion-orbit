...
const SHIP_BASE_INFO = {
  ...
  orcus: { effet: "+50% stats des modules équipés", competence: "Duplication / Assimilation" },
  ...
  police: { effet: null, competence: "Toutes les aptitudes" },
  ...
  orcus_plus: { effet: "Modules équipés x2", competence: null },
  ...
  spearhead_plus: { effet: null, competence: "Camouflage ultime / JAMX Creed / Marqueurs / Recon" },
  tartarus_plus: { effet: null, competence: "Tir rapide Plus / Boost vitesse Plus" },
  spectrum_plus: { effet: "+25% Bouclier", competence: "Réflexion prismatique" },
...
const SHIP_EFFECT_STATS = {
  ...
  solace: { shieldPct: 10 },
  spectrum: { shieldPct: 25 },
  spectrum_plus: { shieldPct: 25 },
  venom: { damagePct: 5 },
