...
export const CATALOG = {
  ...
  ammo: [
  { id: "ammo_x2", name: "MCB-25", price: 50000, give: { ammo: { x2: 1000 } },
  ...
  { id: "ammo_x6", name: "RSB-75", price: 1500000, give: { ammo: { x6: 1000 } },
  ...
  { id: "ammo_job", name: "JOB-100", price: 250000, give: { ammo: { job: 1000 } },
  ...
  { id: "ammo_pib", name: "PIB-100", price: 1400000, give: { ammo: { pib: 1000 } },
    code: "PIB-100", mult: 4, laser: "vert",
    desc: "Dégâts quadruplés (×4) + infecte la cible (vitesse −10 %, 15 s).", effect: "Tirs verts." },
  { id: "ammo_idb", name: "IDB-125", price: 1800000, give: { ammo: { idb: 1000 } },
    code: "IDB-125", mult: 1, laser: "magenta (progressif)",
    desc: "Dégâts progressifs jusqu'à ×6. Retombe à ×1 après 3 s sans tirer.", effect: "Tirs magenta." },
  ...
  speedGen: [
    ...
    { id: "spd_g3n4900", name: "G3N-4900", price: 600000, icon: "/ASSETS/ITEMS/G3N-3310.png", module: { type: "speed",  bonusSpeed: 6 } },
    { id: "spd_g3n6900", name: "G3N-6900", price: 5000000, icon: "/ASSETS/ITEMS/G3N-6900.png", module: { type: "speed",  bonusSpeed: 7 } },
    { id: "spd_g3n7900", name: "G3N-7900", price: 12000000, icon: "/ASSETS/ITEMS/G3N-7900.png", module: { type: "speed",  bonusSpeed: 10 } },
  ],
  ...
  shieldGen: [
    ...
    { id: "shd_sg3na02", name: "SG3N-A02", price: 40000, icon: "/ASSETS/ITEMS/SG3N-A02.png", module: { type: "shield", bonusShield: 5000, absorbPct: 50 } },
    ...
    { id: "shd_sg3nb00", name: "SG3N-B00", price: 1400000, icon: "/ASSETS/ITEMS/SG3N-B00.png", module: { type: "shield", bonusShield: 9000, absorbPct: 70 } },
    { id: "shd_sg3nb01", name: "SG3N-B01", price: 1800000, icon: "/ASSETS/ITEMS/SG3N-B01.png", module: { type: "shield", bonusShield: 9500, absorbPct: 70 } },
    ...
    { id: "shd_sg3nb03", name: "SG3N-B03", price: 22000000, icon: "/ASSETS/ITEMS/SG3N-B03.png", module: { type: "shield", bonusShield: 11450, absorbPct: 80 } },
  ...
  lasers: [
    ...
    { id: "laser_mp1", name: "laser MP-1", price: 20000, icon: "/ASSETS/LASERS/mp_1_100x100.png", module: { type: "laser", damage: 60, playerDamage: 70 }, desc: "60 dégâts vs aliens, 70 vs joueurs." },
    ...
    { id: "laser_ulf4", name: "laser U-LF4 Instable", price: 5500000, icon: "/ASSETS/LASERS/lf_4_unstable_100x100.png", module: { type: "laser", damage: 174, unstable: true }, desc: "128 à 220 dégâts aléatoires par tir." },
    ...
    { id: "laser_aa1", name: "laser AA-1", price: 11000000, icon: "/ASSETS/LASERS/aa_1_100x100.png", module: { type: "laser", damage: 180, vsMatch: [/Mimesis/], vsMult: 305 / 180, vsLabel: "Mimesis" }, desc: "180 dégâts, 305 vs Mimesis (anti-AI)." },
    ...
    { id: "laser_lf4md", name: "laser LF-4 Magmadrill", price: 22000000, icon: "/ASSETS/LASERS/lf_4_md_100x100.png", module: { type: "laser", damage: 230 }, desc: "230 dégâts, bonus PVP (sans effet vs aliens)." },
  ...
  pets: [
    { id: "pet_niveau1", name: "P.E.T", price: 16000000, icon: "/PET/PET_SPRITES/NIVEAU5/29.png", pet: { id: "niveau1" } },
    { id: "pet_fuel", name: "Essence P.E.T", price: 100, icon: "/PET/pet-fuel_100x100.png", petFuel: { units: 1 }, desc: "Recharge le réservoir du REX (+1 carburant / unité)." },
  ...
  petGears: [
    ...
    { id: "gear_grep1", name: "G-REP1 · Réparateur", price: 5000000, icon: "/PET/PET_GEARS/G-REP1.png", petLevel: 0, petGear: { key: "rep", level: 1 }, desc: "Régénère 3 % de la coque /s." },
  ...
  // aucun effet, ni en boutique ni équipée.
  petProtocols: [
