...
enabled: true,
    ...
    preload() {
      ...
      api.preloaded = Promise.all([
        api.load("pShotX1", "AUDIO/SFX_SHOT_X1.mp3"),
        api.load("pShotX2", "AUDIO/SFX_SHOT_X2.mp3"),
        ...
        api.load("rocketLoad", "AUDIO/ROCKETLOAD.mp3"),
        api.load("rocketsLoaded", "AUDIO/ROCKETSLOADED.mp3"),
        api.load("pShotSab", "AUDIO/SFX_SHOT_SAB.mp3"),
        api.load("pulseIEM", "AUDIO/IEM_INSTANT.mp3"),
        api.load("ishShield", "AUDIO/BOUCLIER_INSTANT.mp3"),
        api.load("deathPlayer", "AUDIO/MORT_JOUEUR.mp3"),
        api.load("deathPlayer2", "AUDIO/MORT_JOUEUR_2.mp3"),
        api.load("respawnPlayer", "AUDIO/REAPPARITION.mp3"),
        api.load("radiationLoop", "AUDIO/RADIATION.mp3"),
        api.load("repairStart", "AUDIO/REPAIR_START.mp3"),
        api.load("repairLoop", "AUDIO/REPAIR.mp3"),
        api.load("swReady", "AUDIO/SAUT_POSSIBLE.mp3"),
        api.load("swJump", "AUDIO/SAUT_EN_COURS.mp3"),
        api.load("swDone", "AUDIO/SAUT_TERMINEE.mp3"),
        api.load("swDeny", "AUDIO/SAUT_IMPOSSIBLE.mp3"),
        api.load("shipMove", "AUDIO/SHIP_MOVE.mp3"),
        api.load("npcDeath", "AUDIO/MORT_AUTRE.mp3"),
        api.load("collect", "AUDIO/RECOLTE.mp3"),
        api.load("laserHit1", "AUDIO/LASERHIT_1.mp3"),
        api.load("laserHit2", "AUDIO/LASERHIT_2.mp3"),
        api.load("laserHit3", "AUDIO/LASER_HIT_3.mp3"),
        api.load("selectNew", "AUDIO/SELECTION_NOUVELLE.mp3"),
        api.load("selectAgain", "AUDIO/SELECTION_DEJA.mp3"),
        api.load("shieldSelected", "AUDIO/SHIELD_SELECTED.mp3"),
        api.load("shieldShimmer", "AUDIO/SHIELD_SELECTED.mp3"),
        api.load("outOfRange", "AUDIO/OUT_OF_RANGE.mp3"),
        api.load("escortX1", "AUDIO/SFX_SHOT_X1.mp3"),
        api.load("escortX2", "AUDIO/SFX_SHOT_X2.mp3"),
        api.load("escortX3", "AUDIO/SFX_SHOT_X3.mp3"),
        api.load("escortX4", "AUDIO/SFX_SHOT_X4.mp3"),
        api.load("escortX6", "AUDIO/SFX_SHOT_X6.mp3"),
        api.load("escortSab", "AUDIO/SFX_SHOT_SAB.mp3"),
      ]).catch(() => {});
    },
