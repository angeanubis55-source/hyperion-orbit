(() => {
  ...
  function bringWindowToFront(card) {
    ...
    // L'Espace pilote vit dans #profileOverlay : on remonte le conteneur
    // avec la carte, sinon son z-index fixe (90000) le garderait toujours
    // derrière les fenêtres HUD déjà remontées.
    const overlay = card.closest("#profileOverlay");
    ...
    if (topZ >= 95000) {
      [...document.querySelectorAll(".gameWindow"), document.getElementById("profileOverlay")]
