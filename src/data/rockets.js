...
function def(id, name, short, file, damage, cooldown, packPrice, manual = true, packSize = 10) {
  return Object.freeze({ id, name, short, file, damage, cooldown, packPrice, packSize, manual });
}
...
export const ROCKET_TYPES = Object.freeze({
  ...
  plt2021: def("plt2021", "Roquette PLT-2021", "021", "plt-2021_100x100.png", 1500, 1.0, 60000),
  plt2026: def("plt2026", "Roquette PLT-2026", "026", "plt-2026_100x100.png", 2000, 1.0, 120000),
  plt3030: def("plt3030", "Roquette PLT-3030", "030", "plt-3030_100x100.png", 3000, 1.0, 300000),
  dcr250: def("dcr250", "Roquette DCR-250", "DCR", "dcr-250_100x100.png", 500, 1.0, 12000),
  pld8: def("pld8", "Roquette PLD-8", "PLD", "pld-8_100x100.png", 1750, 1.0, 90000),
  // Lance-roquettes : pas de tir manuel pour l'instant (mécanique à venir).
  eco10: def("eco10", "Roquette ECO-10", "ECO", "eco-10_100x100.png", 1000, 3.0, 15000, false),
  ubr100: def("ubr100", "Roquette UBR-100", "UBR", "ubr-100_100x100.png", 2500, 3.5, 200000, false),
  cbr: def("cbr", "Roquette CBR", "CBR", "cbr_100x100.png", 800, 3.0, 40000, false),
  sar01: def("sar01", "Roquette SAR-01", "SA1", "sar-01_100x100.png", 1250, 3.0, 50000, false),
  sar02: def("sar02", "Roquette SAR-02", "SA2", "sar-02_100x100.png", 2250, 3.5, 160000, false),
  hstrm01: def("hstrm01", "Roquette HSTRM-01", "HST", "hstrm-01_100x100.png", 2000, 4.0, 150000, false),
});
