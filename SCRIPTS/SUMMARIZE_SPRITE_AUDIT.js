...
const file = 'TEST/REPORTS/sprite-atlas-audit/results.json';
...
const current = JSON.parse(await readFile('TEST/REPORTS/current-streuner-audit/results.json', 'utf8')).groups[0];
...
\`\`\`powershell
python SCRIPTS/AUDIT_SPRITE_ATLASES.py .tmp-atlas-audit
node SCRIPTS/AUDIT_SPRITE_ATLASES.js .tmp-atlas-audit
node SCRIPTS/SUMMARIZE_SPRITE_AUDIT.js
\`\`\`
...
`;
await writeFile('TEST/REPORTS/sprite-atlas-audit/README.md', text);
