...
export function getZoneSafeModules(WORLD) {
  ...
  // ============================================================
  const modules = [
    { id: "m1", x: 5000,   y: 1000,   w: 671, h: 781, spr: "M1" },
    { id: "m2", x: 6000,   y: 1000,   w: 515, h: 728, spr: "M2" },
    { id: "m3", x: 6000,   y: 2000,   w: 585, h: 511, spr: "M3" },
    { id: "m4", x: 5000,   y: 2000,   w: 412, h: 302, spr: "M4" },
  ];
