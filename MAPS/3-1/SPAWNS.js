...
export function getZonePortals(WORLD) {
 ...
 sprites: {
    idle: {
      src: "ASSETS/ALPHA_PORTAL/DESACTIVE.png",
      w: 500,
      h: 500,
      yOff: 0,
    },
    ...
    open: {
      src: "ASSETS/ALPHA_PORTAL/ACTIVE.png",
      w: 500,
      h: 500,
      yOff: 0,
    },
 ...
 sprites: {
    idle: {
      src: "ASSETS/BETA_PORTAL/DESACTIVE.png",
      w: 437,
      h: 456,
      yOff: 0,
    },
    ...
    open: {
      src: "ASSETS/BETA_PORTAL/ACTIVE.png",
      w: 437,
      h: 456,
      yOff: 0,
    },
 ...
 sprites: {
    idle: {
      src: "ASSETS/GAMMA_PORTAL/DESACTIVE.png",
      w: 360,
      h: 421,
      yOff: 0,
    },
    ...
    open: {
      src: "ASSETS/GAMMA_PORTAL/ACTIVE.png",
      w: 360,
      h: 421,
      yOff: 0,
    },
...
export function getZoneSafeModules(WORLD) {
  ...
  const modules = [
    { id: "CENTRE_VRU", x: 9500, y: 5500, w: 571, h: 1155, spr: "CENTRE_VRU", questTerminal: true, oreTrade: true },
  ];
  ...
  const margin = 800; // Zone autour de la base
